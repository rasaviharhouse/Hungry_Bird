...
class Edrone():
	...
	def __init__(self):
		...
		# [x,y,z,yaw_value]
		self.drone_position = [5.61,-1.89,54.95,0.0]	

		# [x_setpoint, y_setpoint, z_setpoint, yaw_value_setpoint]
		self.setpoint = [5.68,-1.91,33.4,0.0] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
